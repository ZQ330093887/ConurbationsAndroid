...
import com.test.admin.conurbations.databinding.FragmentBeautifulArticleItemDetailBinding;
 ...
 */
public class BeautifulArticleItemDetailFragment extends BaseFragment<FragmentBeautifulArticleItemDetailBinding> {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0x123456) {
                ...
                mBinding.get().tvBeautifulArticleItemDetailContent.setTypeface(tf);
                mBinding.get().tvBeautifulArticleItemDetailContent.setText(detailContext);
                text = detailContext;
            }
        }
    };
    ...
    protected int getLayoutId() {
        return R.layout.fragment_beautiful_article_item_detail;
    }
