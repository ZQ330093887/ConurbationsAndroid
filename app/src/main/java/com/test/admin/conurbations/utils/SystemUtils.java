...
public class SystemUtils {
    ...
    public static boolean isOpenFloatWindow() {
        return FloatUtil.INSTANCE.checkPermission(SolidApplication.getInstance());
    }
    ...
    public static void applySystemWindow() {
        FloatUtil.INSTANCE.applyOrShowFloatWindow(SolidApplication.getInstance());
    }
    ...
    private static boolean isNoOptions() {
        PackageManager packageManager = SolidApplication.getInstance().getPackageManager();
    ...
    private static boolean isNoSwitch() {
        ...
        UsageStatsManager usageStatsManager = (UsageStatsManager) SolidApplication.getInstance().getSystemService(Context.USAGE_STATS_SERVICE);
