...
/**
 * 圆形图片、圆角图片、椭圆图片
 * Created by zhouqiong on 2016/9/22.
 */
...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        type = a.getInt(R.styleable.CircleImageView_type, TYPE_OVAL);
        mBorderColor = a.getColor(R.styleable.CircleImageView_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.CircleImageView_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.CircleImageView_corner_radius, dp2px(10));
        mLeftTopCornerRadius = a.getDimension(R.styleable.CircleImageView_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.CircleImageView_leftBottom_corner_radius, 0);
        mRightTopCornerRadius = a.getDimension(R.styleable.CircleImageView_rightTop_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.CircleImageView_rightBottom_corner_radius, 0);
     ...
     * 默认为圆形图片
     */
    public CircleImageView setType(int imageType) {
     ...
     * 设置圆角图片的圆角大小
     */
    public CircleImageView setCornerRadius(int cornerRadius) {
     ...
     * 设置圆角图片的左上圆角大小
     */
    public CircleImageView setLeftTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右上圆角大小
     */
    public CircleImageView setRightTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的左下圆角大小
     */
    public CircleImageView setLeftBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右下圆角大小
     */
    public CircleImageView setRightBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置描边宽度
     */
    public CircleImageView setBorderWidth(int borderWidth) {
