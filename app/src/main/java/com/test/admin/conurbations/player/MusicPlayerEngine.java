...
import static com.test.admin.conurbations.player.MusicPlayerService.PLAYER_PREPARED;
import static com.test.admin.conurbations.player.MusicPlayerService.PREPARE_ASYNC_UPDATE;
import static com.test.admin.conurbations.player.MusicPlayerService.RELEASE_WAKELOCK;
import static com.test.admin.conurbations.player.MusicPlayerService.TRACK_PLAY_ENDED;
import static com.test.admin.conurbations.player.MusicPlayerService.TRACK_PLAY_ERROR;
import static com.test.admin.conurbations.player.MusicPlayerService.TRACK_WENT_TO_NEXT;


/**
 * Created by ZQiong on 2018/1/16.
 */
