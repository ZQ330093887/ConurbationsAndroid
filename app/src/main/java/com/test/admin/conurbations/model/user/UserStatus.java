...
/**
 * Created by ZQiong on 2018/12/22.
 */
public class UserStatus {
    //保存个人信息到user.xml文件中
    public static void saveUserInfo(User userInfo) {
        SharedPreferences sp = SolidApplication.getInstance().getSharedPreferences("user", Context.MODE_PRIVATE);
    ...
    public static User getUserInfo() {
        ...
        user.setNickname(sp.getString(Constants.NICK, null));
